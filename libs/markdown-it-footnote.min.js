...
!(function (e, o) {
   "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof define && define.amd
        ? define(o)
        : ((e = "undefined" != typeof globalThis ? globalThis : e || self).markdownitFootnote = o());
})(this, function () {
   "use strict";
   function e(e, o, t, n) {
   ...
   function t(e, o, t, n, r) {
      ...
      return (
         ...
         `<sup class="footnote-ref"><a href="#fn${s}" id="fnref${l}">${f}</a></sup>`
      );
   }
   function n(e, o, t) {
      return (
         (t.xhtmlOut ? '<hr class="footnotes-sep" />\n' : '<hr class="footnotes-sep">\n') +
   ...
   function l(e, o, t, n, r) {
      ...
      return (
         ...
         ` <a href="#fnref${s}" class="footnote-backref">\u21a9\ufe0e</a>`
      );
   }
   return function (c) {
      const i = c.helpers.parseLinkLabel,
         u = c.utils.isSpace;
      (c.renderer.rules.footnote_ref = t),
         (c.renderer.rules.footnote_block_open = n),
         (c.renderer.rules.footnote_block_close = r),
         (c.renderer.rules.footnote_open = s),
         (c.renderer.rules.footnote_close = f),
         (c.renderer.rules.footnote_anchor = l),
         (c.renderer.rules.footnote_caption = o),
         (c.renderer.rules.footnote_anchor_name = e),
         c.block.ruler.before(
            "reference",
            "footnote_def",
            function (e, o, t, n) {
               ...
               (c.meta = { label: l }), (c.level = e.level++), e.tokens.push(c);
               const i = e.bMarks[o],
                  a = e.tShift[o],
                  p = e.sCount[o],
                  d = e.parentType,
         ...
         c.inline.ruler.after("image", "footnote_inline", function (e, o) {
            ...
            if (!o) {
               ...
               (e.push("footnote_ref", "", 0).meta = { id: o }),
                  (e.env.footnotes.list[o] = { content: e.src.slice(r, s), tokens: t });
            }
         ...
         c.inline.ruler.after("footnote_inline", "footnote_ref", function (e, o) {
            ...
            if (!o) {
               ...
               e.env.footnotes.list || (e.env.footnotes.list = []),
                  e.env.footnotes.refs[`:${s}`] < 0
                     ? ((o = e.env.footnotes.list.length),
                       (e.env.footnotes.list[o] = { label: s, count: 0 }),
                       (e.env.footnotes.refs[`:${s}`] = o))
                     : (o = e.env.footnotes.refs[`:${s}`]);
               const t = e.env.footnotes.list[o].count;
               e.env.footnotes.list[o].count++;
               e.push("footnote_ref", "", 0).meta = { id: o, subId: t, label: s };
            }
         ...
         c.core.ruler.after("inline", "footnote_tail", function (e) {
            ...
            for (let t = 0, n = f.length; t < n; t++) {
               ...
               if (((n.meta = { id: t, label: f[t].label }), e.tokens.push(n), f[t].tokens)) {
                  o = [];
               ...
               let r;
               o && (e.tokens = e.tokens.concat(o)),
                  (r = "paragraph_close" === e.tokens[e.tokens.length - 1].type ? e.tokens.pop() : null);
               const l = f[t].count > 0 ? f[t].count : 1;
               for (let o = 0; o < l; o++) {
                  const n = new e.Token("footnote_anchor", "", 0);
                  (n.meta = { id: t, subId: o, label: f[t].label }), e.tokens.push(n);
               }
