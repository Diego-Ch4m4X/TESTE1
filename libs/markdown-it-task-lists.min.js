         ...
         1: [
            function (n, e, t) {
               ...
               function c(n, e) {
                  if (
                     ...
                     if (v) {
                        ...
                        (n.children[0].content = n.children[0].content.slice(0, -1) + ' id="' + t + '">'),
               ...
               function l(n, e) {
                  ...
                  return (
                     0 === n.content.indexOf("[ ] ")
                        ? (t.content = '<input class="task-list-item-checkbox"' + i + 'type="checkbox">')
                        : (0 === n.content.indexOf("[x] ") || 0 === n.content.indexOf("[X] ")) &&
                          (t.content = '<input class="task-list-item-checkbox" checked=""' + i + 'type="checkbox">'),
                     t
                  );
               }
               function f(n) {
               ...
               function a(n, e, t) {
                  ...
                  return (
                     (i.content = '<label class="task-list-item-label" for="' + e + '">' + n + "</label>"),
                     (i.attrs = [{ for: e }]),
                     i
                  );
               }
                  ...
                  e && ((x = !e.enabled), (b = !!e.label), (v = !!e.labelAfter)),
                     n.core.ruler.after("inline", "github-task-lists", function (n) {
                        for (var e = n.tokens, t = 2; t < e.length; t++)
                           o(e, t) &&
                              (c(e[t], n.Token),
                              i(e[t - 2], "class", "task-list-item" + (x ? "" : " enabled")),
