...
!(function (t, e) {
   "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof define && define.amd
        ? define(e)
        : ((t = "undefined" != typeof globalThis ? globalThis : t || self).markdownit = e());
})(this, function () {
   "use strict";
   const t = {};
   function e(r, n) {
            ...
            if (i < 128) e += s[i];
               ...
               if (224 == (240 & i) && r + 6 < n) {
                  ...
                  if (128 == (192 & n) && 128 == (192 & s)) {
                     ...
                     (e += t < 2048 || (t >= 55296 && t <= 57343) ? "\ufffd\ufffd\ufffd" : String.fromCharCode(t)),
                        (r += 6);
                     continue;
                  }
               }
   ...
   function n(t, e, s) {
      ...
      for (let e = 0, r = t.length; e < r; e++) {
         ...
         if (s && 37 === n && e + 2 < r && /^[0-9a-f]{2}$/i.test(t.slice(e + 1, e + 3)))
            (o += t.slice(e, e + 3)), (e += 2);
         else if (n < 128) o += i[n];
   ...
   (i.prototype.parse = function (t, e) {
      ...
      let u = o.exec(i);
      if (
         (u && ((u = u[0]), (r = u.toLowerCase()), (this.protocol = u), (i = i.substr(u.length))),
         (e || u || i.match(/^\/\/[^@\/]+@[^@\/]+/)) &&
            ((s = "//" === i.substr(0, 2)), !s || (u && _[u]) || ((i = i.substr(2)), (this.slashes = !0))),
         !_[u] && (s || (u && !m[u])))
      ) {
         let t,
            e,
         ...
         (e = -1 === r ? i.lastIndexOf("@") : i.lastIndexOf("@", r)),
            ...
            (r = -1);
         for (let t = 0; t < h.length; t++) (n = i.indexOf(h[t])), -1 !== n && (-1 === r || n < r) && (r = n);
   ...
   var k,
      D = Object.freeze({ __proto__: null, decode: e, encode: n, format: s, parse: g }),
      C =
         /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,
      y = /[\0-\x1F\x7F-\x9F]/,
      E =
   ...
   class R {
         ...
         switch (this.state) {
            case B.EntityStart:
               return t.charCodeAt(e) === S.NUM
                  ? ((this.state = B.NumericStart), (this.consumed += 1), this.stateNumericStart(t, e + 1))
      ...
      stateNumericStart(t, e) {
         return e >= t.length
            ...
            : (32 | t.charCodeAt(e)) === S.LOWER_X
              ? ((this.state = B.NumericHex), (this.consumed += 1), this.stateNumericHex(t, e + 1))
      ...
      emitNumericEntity(t, e) {
         ...
         return (
            ...
            this.errors &&
               (t !== S.SEMI && this.errors.missingSemicolonAfterCharacterReference(),
      ...
      stateNamedEntity(t, e) {
         ...
         for (; e < t.length; e++, this.excess++) {
            ...
            if (((this.treeIndex = P(r, n, this.treeIndex + Math.max(1, s), i)), this.treeIndex < 0))
               return 0 === this.result || (this.decodeMode === L.Attribute && (0 === s || T(i)))
                  ? 0
      ...
      emitNamedEntityData(t, e, r) {
         ...
         switch (this.state) {
            case B.NamedEntity:
               return 0 === this.result || (this.decodeMode === L.Attribute && this.result !== this.treeIndex)
                  ? 0
                  : this.emitNotTerminatedNamedEntity();
            case B.NumericDecimal:
   ...
   (pt.code_inline = function (t, e, r, n, s) {
      ...
      (pt.fence = function (t, e, r, n, s) {
         ...
         if (((u = (r.highlight && r.highlight(i.content, c, a)) || rt(i.content)), 0 === u.indexOf("<pre")))
            return u + "\n";
         if (o) {
      ...
      (dt.prototype.before = function (t, e, r, n) {
         ...
         this.__rules__.splice(s, 0, { name: e, enabled: !0, fn: r, alt: i.alt || [] }), (this.__cache__ = null);
      }),
      (dt.prototype.after = function (t, e, r, n) {
         const s = this.__find__(t),
            i = n || {};
         if (-1 === s) throw new Error("Parser rule not found: " + t);
         this.__rules__.splice(s + 1, 0, { name: e, enabled: !0, fn: r, alt: i.alt || [] }), (this.__cache__ = null);
      }),
               ...
               if (p)
                  for (r = n.length - 1; r >= 0; r--) {
                     ...
                     if (h.single === f && n[r].level === o) {
                        ...
                        (h = n[r]),
                           f
                              ? ((o = e.md.options.quotes[2]), (p = e.md.options.quotes[3]))
                              : ((o = e.md.options.quotes[0]), (p = e.md.options.quotes[1])),
               ...
               for (let n = 0, s = e.length; n < s; n++) {
                  ...
                  for (let o = s.length - 1; o >= 0; o--) {
                     ...
                     if ("link_close" !== u.type) {
                        if (
                           ("html_inline" === u.type &&
                              ((r = u.content), /^<a[>\s]/i.test(r) && i > 0 && i--, Dt(u.content) && i++),
                           ...
                           for (let e = 0; e < i.length; e++) {
                              ...
                              o = i[e].schema
                                 ? "mailto:" !== i[e].schema || /^mailto:/i.test(o)
                                    ...
                                    : t.md.normalizeLinkText("mailto:" + o).replace(/^mailto:/, "")
                                 : t.md.normalizeLinkText("http://" + o).replace(/^http:\/\//, "");
                              const u = i[e].index;
                              if (u > l) {
                     ...
                     } else for (o--; s[o].level !== u.level && "link_open" !== s[o].type; ) o--;
                  }
               }
         },
      ],
         ...
         function (t) {
            if (t.md.options.typographer)
               for (let e = t.tokens.length - 1; e >= 0; e--)
                  "inline" === t.tokens[e].type && wt.test(t.tokens[e].content) && qt(t.tokens[e].children, t);
         },
      ],
      [
         "text_join",
   ...
   (Lt.prototype.process = function (t) {
      ...
      (It.prototype.push = function (t, e, r) {
         ...
         return (
            (n.block = !0), r < 0 && this.level--, (n.level = this.level), r > 0 && this.level++, this.tokens.push(n), n
         );
      }),
   ...
   function Tt(t) {
      ...
      for (; n < r; )
         124 === s &&
            (i ? ((u += t.substring(o, n - 1)), (o = n)) : (e.push(u + t.substring(o, n)), (u = ""), (o = n + 1))),
            (i = 92 === s),
            n++,
            (s = t.charCodeAt(n));
      ...
      [
         ...
         function (t, e, r, n) {
            ...
            for (
               ;
               (h++, !(h >= r)) &&
               ((s = u = t.bMarks[h] + t.tShift[h]), (i = t.eMarks[h]), !(s < i && t.sCount[h] < t.blkIndent));
               ...
               if (
                  ...
                  !(
                     ...
                     ((s = t.skipChars(s, o)), s - u < c || ((s = t.skipSpaces(s)), s < i))
                  )
               ) {
                  p = !0;
                  break;
      ...
      [
         ...
         function (t, e, r, n) {
               ...
               if (62 === t.src.charCodeAt(s++) && !e) {
                  ...
                  32 === t.src.charCodeAt(s)
                     ...
                     : 9 === t.src.charCodeAt(s)
                       ? ((e = !0), (t.bsCount[f] + n) % 4 == 3 ? (s++, n++, (r = !1)) : (r = !0))
                       : (e = !1);
                  let o = n;
            ...
            for (let r = 0; r < l.length; r++)
               (t.bMarks[r + e] = u[r]), (t.tShift[r + e] = l[r]), (t.sCount[r + e] = a[r]), (t.bsCount[r + e] = c[r]);
      ...
      [
         ...
         function (t, e, r, n) {
            ...
            if ((n && "paragraph" === t.parentType && t.sCount[c] >= t.blkIndent && (f = !0), (p = Nt(t, c)) >= 0)) {
               if (((l = !0), (o = t.bMarks[c] + t.tShift[c]), (h = Number(t.src.slice(o, p - 1))), f && 1 !== h))
                  return !1;
            } else {
            ...
            const d = t.src.charCodeAt(p - 1),
               _ = t.tokens.length;
            l
               ? ((u = t.push("ordered_list_open", "ol", 1)), 1 !== h && (u.attrs = [["start", h]]))
            ...
            for (t.parentType = "list"; c < r; ) {
               ...
               if (
                  ...
                  (t.sCount[c] = n),
                  h >= s && t.isEmpty(c + 1) ? (t.line = Math.min(t.line + 2, r)) : t.md.block.tokenize(t, c, r, !0),
                  (t.tight && !g) || (a = !1),
            ...
            return (
               (u = l ? t.push("ordered_list_close", "ol", -1) : t.push("bullet_list_close", "ul", -1)),
               (u.markup = String.fromCharCode(d)),
               (m[1] = c),
               (t.line = c),
               (t.parentType = D),
         ...
         function (t, e, r, n) {
            ...
            return (
               ...
               (n ||
                  ...
                  void 0 === t.env.references[g] && (t.env.references[g] = { title: _, href: h }),
                  (t.line = o)),
               !0)
            );
         },
      ...
      [
         ...
         function (t, e, r, n) {
            ...
            return (
               ...
               (l.map = [e, t.line]),
               (l.children = []),
               (t.push("heading_close", "h" + String(u), -1).markup = "########".slice(0, u)),
               !0
            );
         },
         ["paragraph", "reference", "blockquote"],
      ...
      [
         ...
         function (t, e, r) {
            ...
            return (
               ...
               (l.map = [e, t.line - 1]),
               (l.children = []),
               (t.push("heading_close", "h" + String(o), -1).markup = String.fromCharCode(i)),
               (t.parentType = s),
               !0
            );
         },
   ...
   function Ht() {
      this.ruler = new dt();
      for (let t = 0; t < Ut.length; t++) this.ruler.push(Ut[t][0], Ut[t][1], { alt: (Ut[t][2] || []).slice() });
   }
   function Vt(t, e, r, n) {
      (this.src = t),
         (this.env = r),
   ...
   (Ht.prototype.tokenize = function (t, e, r) {
      ...
      (Vt.prototype.scanDelims = function (t, e) {
         ...
         const o = i - t,
            ...
            p = !h && (!a || l || c),
            f = !l && (!c || h || a);
         return { can_open: p && (e || !f || c), can_close: f && (e || !p || a), length: o };
      }),
   ...
   function Qt(t, e) {
      ...
      for (let i = 0; i < s; i++) {
         ...
         (r = t.tokens[s.token]),
            ...
            (r.markup = "~~"),
            (r.content = ""),
            "text" === t.tokens[o.token - 1].type && "~" === t.tokens[o.token - 1].content && n.push(o.token - 1);
      }
      for (; n.length; ) {
         const e = n.pop();
         let s = e + 1;
   ...
   function Yt(t, e) {
      for (let r = e.length - 1; r >= 0; r--) {
         ...
         (c.type = i ? "strong_close" : "em_close"),
            ...
            (c.markup = i ? o + o : o),
            (c.content = ""),
            i && ((t.tokens[e[r - 1].token].content = ""), (t.tokens[e[n.end + 1].token].content = ""), r--);
      }
   }
   var Kt = {
      tokenize: function (t, e) {
         ...
         [
            ...
            function (t, e) {
               ...
               if (!e) {
                  ...
                  (e.attrs = [["href", u]]), (e.markup = "linkify"), (e.info = "auto");
            ...
            function (t, e) {
               ...
               if (d < h && 40 === t.src.charCodeAt(d)) {
                  ...
                  if (((c = d), (s = t.md.helpers.parseLinkDestination(t.src, d, t.posMax)), s.ok)) {
                     for (
                        o = t.md.normalizeLink(s.str), t.md.validateLink(o) ? (d = s.pos) : (o = ""), c = d;
               ...
               if (((i = d + 1), i < p && 40 === t.src.charCodeAt(i))) {
                  ...
                  for (
                     a = i,
                        ...
                        u.ok && ((l = t.md.normalizeLink(u.str)), t.md.validateLink(l) ? (i = u.pos) : (l = "")),
                        a = i;
         ...
         [
            ...
            function (t, e) {
               ...
               if (ee.test(i)) {
                  ...
                  if (!e) {
                     const e = t.push("link_open", "a", 1);
                     (e.attrs = [["href", r]]), (e.markup = "autolink"), (e.info = "auto");
         ...
         return (
            ...
            this.__opts__.fuzzyEmail &&
               ...
               a >= 0 &&
                  ...
                  (this.__index__ < 0 || i < this.__index__ || (i === this.__index__ && o > this.__last_index__)) &&
                     ((this.__schema__ = "mailto:"), (this.__index__ = i), (this.__last_index__ = o)))),
            this.__index__ >= 0
         );
      }),
         ...
         return (
            ...
            e
               ? ((this.__tlds__ = this.__tlds__
                 ...
                 me(this),
                 this)
               : ((this.__tlds__ = t.slice()), (this.__tlds_replaced__ = !0), me(this), this)
         );
      }),
   ...
   return (
      ...
      ($e.prototype.configure = function (t) {
         ...
         if (Z(t)) {
            const e = t;
            if (!(t = Te[e])) throw new Error('Wrong `markdown-it` preset "' + e + '", check name');
         }
