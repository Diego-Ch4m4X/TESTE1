   ...
   return (function () {
      ...
      function N(e, t, r) {
         ...
         let n = e.charCodeAt(0),
            o = T[t][n];
         if (
            (!o && e[0] in C && ((n = C[e[0]].charCodeAt(0)), (o = T[t][n])),
      ...
      class O {
         ...
         havingSize(e) {
            return this.size === e && this.textSize === e
               ? this
               : this.extend({ style: this.style.text(), size: e, textSize: e, sizeMultiplier: R[e - 1] });
         }
         havingBaseStyle(e) {
            e = e || this.style.text();
            const t = H(O.BASESIZE, e);
            return this.size === t && this.textSize === O.BASESIZE && this.style === e
               ? this
      ...
      class Z {
         ...
         toNode() {
            ...
            let t = null;
            this.italic > 0 && ((t = document.createElement("span")), (t.style.marginRight = F(this.italic))),
               this.classes.length > 0 && ((t = t || document.createElement("span")), (t.className = G(this.classes)));
            for (const e in this.style)
               this.style.hasOwnProperty(e) &&
                  ((t = t || document.createElement("span")), (t.style[e] = this.style[e]));
      ...
      function se(e, t, r, n, o, s) {
         (ne[e][o] = { font: t, group: r, replace: n }), s && n && (ne[e][n] = ne[e][o]);
      }
      const ie = "math",
         ae = "text",
         le = "main",
      ...
      const Te = [
         ...
         Ce = function (e, t, r) {
            return oe[r][e] && oe[r][e].replace && (e = oe[r][e].replace), { value: e, metrics: N(e, t, r) };
         },
         Ne = function (e, t, r, n, o) {
            ...
            if (((e = s.value), i)) {
               ...
               "undefined" != typeof console &&
                  console.warn("No character metrics for '" + e + "' in style '" + t + "' and mode '" + r + "'"),
            ...
            if (l) {
               ...
               if ("boldsymbol" === l) {
                  const t = (function (e, t, r, n, o) {
                     return "textord" !== o && Ce(e, "Math-BoldItalic", t).metrics
                  ...
                  a
                     ? ((e = Le[l].fontName), (n = [l]))
                     : ((e = Ee(l, t.fontWeight, t.fontShape)), (n = [l, t.fontWeight, t.fontShape]));
               if (Ce(s, e, o).metrics) return Ne(s, e, o, t, i.concat(n));
               if (ve.hasOwnProperty(s) && "Typewriter" === e.slice(0, 10)) {
                  const r = [];
                  for (let a = 0; a < s.length; a++) r.push(Ne(s[a], e, o, t, i.concat(n)));
                  return Oe(r);
               }
            }
            if ("mathord" === r) return Ne(s, "Math-Italic", o, t, i.concat(["mathnormal"]));
            if ("textord" === r) {
               const e = oe[o][s] && oe[o][s].font;
               if ("ams" === e) {
                  const e = Ee("amsrm", t.fontWeight, t.fontShape);
                  return Ne(s, e, o, t, i.concat("amsrm", t.fontWeight, t.fontShape));
               }
               if ("main" !== e && e) {
                  const r = Ee(e, t.fontWeight, t.fontShape);
                  return Ne(s, r, o, t, i.concat(r, t.fontWeight, t.fontShape));
               }
               {
                  const e = Ee("textrm", t.fontWeight, t.fontShape);
                  return Ne(s, e, o, t, i.concat(t.fontWeight, t.fontShape));
               }
            }
      ...
      const Pe = { number: 3, unit: "mu" },
         ...
         Ue = {
            ...
            mpunct: { mord: Pe, mop: Pe, mrel: Ge, mopen: Pe, mclose: Pe, mpunct: Pe, minner: Pe },
            minner: { mord: Pe, mop: Pe, mbin: Fe, mrel: Ge, mopen: Pe, mpunct: Pe, minner: Pe },
         },
         Ye = {
            mord: { mop: Pe },
            mop: { mord: Pe, mop: Pe },
      ...
      const Ze = function (e) {
         ...
         tt = { display: w.DISPLAY, text: w.TEXT, script: w.SCRIPT, scriptscript: w.SCRIPTSCRIPT },
         rt = {
            mord: "mord",
            mop: "mop",
            mbin: "mbin",
         ...
         nt = function (e, t, r, n) {
            ...
            if (1 === e.length) {
               ...
               "sizing" === r.type
                  ...
                  : "styling" === r.type && (s = t.havingStyle(tt[r.style]));
            }
            ...
            return (
               ot(
                  ...
                  (e, t) => {
                     ...
                     "mbin" === r && l.contains(et, n)
                        ? (t.classes[0] = "mord")
                        : "mbin" === n && l.contains(Qe, r) && (e.classes[0] = "mord");
                  },
                  { node: i },
                  a,
                  h
               ...
               ot(
                  ...
                  (e, t) => {
                     const r = at(t),
                        n = at(e),
                        o = r && n ? (e.hasClass("mtight") ? Ye[r][n] : Ue[r][n]) : null;
         ...
         at = function (e, t) {
            return e ? (t && (e = it(e, t)), rt[e.classes[0]] || null) : null;
         },
         lt = function (e, t) {
      ...
      function mt(e, t) {
         ...
         for (let e = 0; e < n.length; e++)
            if ((a.push(n[e]), n[e].hasClass("mbin") || n[e].hasClass("mrel") || n[e].hasClass("allowbreak"))) {
               ...
               r || (s.push(ct(a, t)), (a = []));
            } else n[e].hasClass("newline") && (a.pop(), a.length > 0 && (s.push(ct(a, t)), (a = [])), s.push(n[e]));
         a.length > 0 && s.push(ct(a, t)),
            r ? ((i = ct(nt(r, t, !0))), (i.classes = ["tag"]), s.push(i)) : o && s.push(o);
      ...
      const ft = function (e, t, r) {
         ...
         yt = function (e, t) {
            ...
            return N(o, Ve.fontMap[r].fontName, n) ? Ve.fontMap[r].variant : null;
         },
         xt = function (e, t, r) {
            if (1 === e.length) {
               const n = vt(e[0], t);
      ...
      function kt(e, t, r, n, o) {
         ...
         let i;
         i =
            1 === s.length && s[0] instanceof ut && l.contains(["mrow", "mtable"], s[0].type)
               ? s[0]
      ...
      var Bt = function (e, t, r, n, o) {
            ...
            if (/fbox|color|angl/.test(t)) {
               if (((s = Ve.makeSpan(["stretchy", t], [], o)), "fbox" === t)) {
               ...
               const e = [];
               /^[bx]cancel$/.test(t) &&
                  e.push(new Q({ x1: "0", y1: "0", x2: "100%", y2: "100%", "stroke-width": "0.046em" })),
                  /^x?cancel$/.test(t) &&
                     e.push(new Q({ x1: "0", y1: "100%", x2: "100%", y2: "0", "stroke-width": "0.046em" }));
         ...
         Ct = function (e) {
            const t = new gt.MathNode("mo", [new gt.TextNode(At[e.replace(/^\\/, "")])]);
         ...
         Nt = function (e, t) {
            const {
               ...
               if (l.contains(["widehat", "widecheck", "widetilde", "utilde"], n)) {
                  ...
                  return { span: Ve.makeSvgSpan([], [c], t), minWidth: 0, height: l };
               }
               {
                  const e = [],
                     o = Tt[n],
                  ...
                  return { span: Ve.makeSpan(["stretchy"], e, t), minWidth: i, height: l };
               }
               var o;
            })();
      ...
      const Ht = (e, t) => {
            ...
            const a = "\\c" === n.label;
            let h,
               c = a ? s.height + s.depth : Math.min(s.height, t.fontMetrics().xHeight);
            if (n.isStretchy)
               (h = Nt(n, t)),
                  (h = Ve.makeVList(
                     {
                        ...
                        children: [
                           { type: "elem", elem: s },
                           {
                              ...
                              wrapperStyle:
                                 i > 0 ? { width: "calc(100% - " + F(2 * i) + ")", marginLeft: F(2 * i) } : void 0,
                           },
                        ],
                     },
                     t
               ...
               let e, r;
               "\\vec" === n.label
                  ? ((e = Ve.staticSvg("vec", t)), (r = Ve.svgData.vec[1]))
                  : ((e = Ve.makeOrd({ mode: n.mode, text: n.label }, t, "textord")),
                    (e = ee(e)),
                    (e.italic = 0),
                    (r = e.width),
                    a && (c += e.depth)),
         ...
         Ot = (e, t) => {
            const r = e.isStretchy ? Ct(e.label) : new gt.MathNode("mo", [ft(e.label, e.mode)]),
      ...
      je({
         ...
         htmlBuilder(e, t) {
            ...
            if (((o.depth > 0.25 || "\\xleftequilibrium" === e.label) && (c -= o.depth), i)) {
               const e = -t.fontMetrics().axisHeight + i.height + 0.5 * a.height + 0.111;
               h = Ve.makeVList(
                  {
            ...
            return (
               h.children[0].children[0].children[1].classes.push("svg-align"), Ve.makeSpan(["mrel", "x-arrow"], [h], t)
            );
         },
         mathmlBuilder(e, t) {
            const r = Ct(e.label);
         ...
         return (
            "minner" === e.mclass
               ...
               : "mord" === e.mclass
                 ...
                 : (e.isCharacterBox ? ((r = n[0]), (r.type = "mo")) : (r = new gt.MathNode("mo", n)),
                   "mbin" === e.mclass
      ...
      je({
         ...
         je({
            ...
            handler(e, t) {
               let { parser: r } = e;
               return { type: "pmb", mode: r.mode, mclass: Ft(t[0]), body: Ke(t[0]) };
            },
            htmlBuilder(e, t) {
               const r = nt(e.body, t, !0),
            ...
            handler(e, t) {
               ...
               return (
                  a <= 65535
                     ...
                     : ((a -= 65536), (i = String.fromCharCode(55296 + (a >> 10), 56320 + (1023 & a)))),
      ...
      je({
         ...
         je({
            ...
            handler(e, t, r) {
               ...
               return { type: "cr", mode: n.mode, newLine: s, size: o && qt(o, "size").value };
            },
            htmlBuilder(e, t) {
            ...
            mathmlBuilder(e, t) {
               ...
               return (
                  e.newLine &&
                     (r.setAttribute("linebreak", "newline"), e.size && r.setAttribute("height", F(P(e.size, t)))),
                  r
               );
            },
         });
      const _t = {
         ...
         $t = (e, t, r, n) => {
            ...
            null == o &&
               ((r.noexpand = !0), (o = { tokens: [r], numArgs: 0, unexpandable: !e.gullet.isExpandable(r.text) })),
      ...
      je({
         ...
         handler(e) {
            ...
            if (_t[o.text])
               return (
                  ("\\global" !== r && "\\\\globallong" !== r) || (o.text = _t[o.text]),
         ...
         je({
            ...
            handler(e) {
               ...
               return (
                  i && h.unshift(i),
                  ("\\edef" !== r && "\\xdef" !== r) || ((h = t.gullet.expandTokens(h)), h.reverse()),
                  t.gullet.macros.set(s, { tokens: h, numArgs: a, delimiters: l }, r === _t[r]),
         ...
         je({
            ...
            handler(e) {
               ...
               return $t(t, n, o, "\\\\globallet" === r), { type: "internal", mode: t.mode };
            },
         }),
         je({
            type: "internal",
      ...
      const Zt = function (e, t, r) {
         ...
         Qt = function (e, t, r, n, o, s) {
            const i = (function (e, t, r, n) {
               ...
               a = Kt(Ve.makeSpan(["delimsizing", "size" + t], [i], n), w.TEXT, n, s);
         ...
         sr = function (e, t, r, n, o, s) {
            ...
            if (m.length > 0) {
               const e = M - g - x,
                  ...
                  a = new K([o], { width: s, height: i, viewBox: "0 0 " + p + " " + t }),
               ...
               if ((T.push(er(c, u, o)), T.push(rr), null === a)) {
                  ...
                  T.push(tr(h, e, n)), T.push(rr), T.push(er(a, u, o)), T.push(rr), T.push(tr(h, e, n));
               }
               T.push(rr), T.push(er(i, u, o));
            }
            const B = n.havingBaseStyle(w.TEXT),
               C = Ve.makeVList({ positionType: "bottom", positionData: A, children: T }, B);
            return Kt(Ve.makeSpan(["delimsizing", "mult"], [C], B), w.TEXT, n, s);
         },
         ir = 0.08,
      ...
      var yr = {
         sqrtImage: function (e, t) {
            ...
            return (
               ...
               (i.height = h),
               (i.style.height = F(l)),
               { span: i, advanceWidth: a, ruleWidth: (t.fontMetrics().sqrtRuleThickness + s) * o }
            );
         },
      ...
      je({
         ...
         htmlBuilder: (e, t) =>
            "." === e.delim ? Ve.makeSpan([e.mclass]) : yr.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
         mathmlBuilder: (e) => {
            const t = [];
         ...
         je({
            ...
            handler: (e, t) => {
               ...
               return { type: "leftright-right", mode: e.parser.mode, delim: vr(t[0], e).text, color: r };
            },
         }),
         je({
            type: "leftright",
            ...
            htmlBuilder: (e, t) => {
               ...
               let n,
                  ...
                  a = !1;
               for (let e = 0; e < r.length; e++)
                  r[e].isMiddle ? (a = !0) : ((s = Math.max(r[e].height, s)), (i = Math.max(r[e].depth, i)));
               if (
                  ((s *= t.sizeMultiplier),
                  (i *= t.sizeMultiplier),
                  (n = "." === e.left ? lt(t, ["mopen"]) : yr.leftRightDelim(e.left, s, i, t, e.mode, ["mopen"])),
                  r.unshift(n),
                  a)
               )
                  for (let t = 1; t < r.length; t++) {
                     const n = r[t].isMiddle;
                     n && (r[t] = yr.leftRightDelim(n.delim, s, i, n.options, e.mode, []));
                  }
               if ("." === e.right) o = lt(t, ["mclose"]);
               else {
                  const r = e.rightColor ? t.withColor(e.rightColor) : t;
                  o = yr.leftRightDelim(e.right, s, i, r, e.mode, ["mclose"]);
               }
         ...
         je({
            ...
            mathmlBuilder: (e, t) => {
               const r = "\\vert" === e.delim || "|" === e.delim ? ft("|", "text") : ft(e.delim, e.mode),
      ...
      const Sr = (e, t) => {
            ...
            if ("sout" === n)
               ...
               (o = Ve.makeSvgSpan(["hide-tail"], [m], t)), (o.style.height = F(a)), (i = r.depth + e + n);
            } else {
               /cancel/.test(n)
               ...
               /box/.test(n)
                  ? ((h = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness)),
                    ...
                    (l = s))
                  : "angl" === n
                    ? ((h = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness)),
                      (s = 4 * h),
                      (l = Math.max(0, 0.25 - r.depth)))
                    : ((s = a ? 0.2 : 0), (l = s)),
                  (o = Bt(r, n, s, l, t)),
                  /fbox|boxed|fcolorbox/.test(n)
                     ? ((o.style.borderStyle = "solid"), (o.style.borderWidth = F(h)))
                     : "angl" === n &&
                       0.049 !== h &&
                       ((o.style.borderTopWidth = F(h)), (o.style.borderRightWidth = F(h))),
                  (i = r.depth + l),
                  e.backgroundColor &&
            ...
            return (
               ...
               /cancel/.test(n) && !a ? Ve.makeSpan(["mord", "cancel-lap"], [c], t) : Ve.makeSpan(["mord"], [c], t)
            );
         },
         Mr = (e, t) => {
            let r = 0;
            const n = new gt.MathNode(e.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [vt(e.body, t)]);
            switch (e.label) {
               case "\\cancel":
         ...
         function w() {
            y &&
               (e.gullet.macros.get("\\df@tag")
                  ? (y.push(e.subparse([new Nr("\\df@tag")])), e.gullet.macros.set("\\df@tag", void 0, !0))
      ...
      const Er = function (e, t) {
            ...
            if (e.colSeparationType && "small" === e.colSeparationType) {
               u = (t.havingStyle(w.SCRIPT).sizeMultiplier / t.sizeMultiplier) * 0.2778;
            }
            const d = "CD" === e.colSeparationType ? P({ number: 3, unit: "ex" }, t) : 12 * p,
               g = 3 * p,
               f = e.arraystretch * d,
               b = 0.7 * f,
               y = 0.3 * f;
            let x = 0;
            function v(e) {
               for (let t = 0; t < e.length; ++t) t > 0 && (x += 0.25), c.push({ pos: x, isDashed: e[t] });
            }
            ...
            for (o = 0, A = 0; o < a || A < S.length; ++o, ++A) {
               ...
               (o > 0 || e.hskipBeforeAndAfter) &&
                  ...
                  0 !== i && ((z = Ve.makeSpan(["arraycolsep"], [])), (z.style.width = F(i)), M.push(z)));
               let d = [];
               for (r = 0; r < s; ++r) {
                  const e = h[r],
                     t = e[o];
               ...
               (d = Ve.makeVList({ positionType: "individualShift", children: d }, t)),
                  (d = Ve.makeSpan(["col-align-" + (c.align || "c")], [d])),
                  M.push(d),
            ...
            if (((h = Ve.makeSpan(["mtable"], M)), c.length > 0)) {
               ...
               h = Ve.makeVList({ positionType: "individualShift", children: n }, t);
            }
            if (0 === T.length) return Ve.makeSpan(["mord"], [h], t);
            {
               let e = Ve.makeVList({ positionType: "individualShift", children: T }, t);
               return (e = Ve.makeSpan(["tag"], [e], t)), Ve.makeFragment([h, e]);
            }
         },
         ...
         Dr = function (e, t) {
            ...
            for (let s = 0; s < e.body.length; s++) {
               const i = e.body[s],
                  a = [];
               for (let e = 0; e < i.length; e++) a.push(new gt.MathNode("mtd", [vt(i[e], t)]));
            ...
            if (e.cols && e.cols.length > 0) {
               ...
               "separator" === t[0].type && ((a += "top "), (o = 1)),
                  "separator" === t[t.length - 1].type && ((a += "bottom "), (i -= 1));
               for (let e = o; e < i; e++)
                  "align" === t[e].type
                     ? ((l += Lr[t[e].align]), n && (r += "none "), (n = !0))
                     : "separator" === t[e].type &&
                       n &&
                       ((r += "|" === t[e].separator ? "solid " : "dashed "), (n = !1));
            ...
            return (
               ...
               "" !== a && ((s = new gt.MathNode("menclose", [s])), s.setAttribute("notation", a.trim())),
               e.arraystretch &&
                  e.arraystretch < 1 &&
                  ((s = new gt.MathNode("mstyle", [s])), s.setAttribute("scriptlevel", "1")),
               s
            );
         },
         Vr = function (e, t) {
      ...
      Ar({
         ...
         props: { numArgs: 1 },
         handler(e, t) {
            const r = (Rt(t[0]) ? [t[0]] : qt(t[0], "ordgroup").body).map(function (e) {
                  const t = It(e).text;
         ...
         Ar({
            ...
            handler(e) {
               ...
               return (
                  ...
                  t ? { type: "leftright", mode: e.mode, body: [s], left: t[0], right: t[1], rightColor: void 0 } : s
               );
            },
            htmlBuilder: Er,
            mathmlBuilder: Dr,
         ...
         Ar({
            ...
            handler(e, t) {
               ...
               if (((o = Hr(e.parser, o, "script")), o.body.length > 0 && o.body[0].length > 1))
                     ...
                     for (let a = 0; a < t.length; a++) {
                        ...
                        for (let t = 0; t < l.length; t++)
                           if (Ut(l[t])) {
                              ...
                              const c = { type: "styling", body: [Yt(o, a, e)], mode: "math", style: "display" };
      ...
      je({
         ...
         handler(e, t) {
            ...
            let i = "";
            for (let e = 0; e < s.body.length; ++e) i += qt(s.body[e], "textord").text;
            if ("\\begin" === o) {
               if (!Pr.hasOwnProperty(i)) throw new n("No such environment: " + i, s);
               const e = Pr[i],
      ...
      const Fr = (e, t) => {
         ...
         Ur = { "\\Bbb": "\\mathbb", "\\bold": "\\mathbf", "\\frak": "\\mathfrak", "\\bm": "\\boldsymbol" };
      je({
         type: "font",
         names: [
            "\\mathrm",
         ...
         handler: (e, t) => {
            ...
            const o = Ze(t[0]);
            let s = n;
            return s in Ur && (s = Ur[s]), { type: "font", mode: r.mode, font: s.slice(1), body: o };
         },
         htmlBuilder: Fr,
         mathmlBuilder: Gr,
      }),
      ...
      const Yr = (e, t) => {
         ...
         Xr = (e, t) => {
            ...
            if (
               (e.hasBarLine
                  ? (e.barSize
                       ? ((h = P(e.barSize, t)), (l = Ve.makeLineSpan("frac-line", t, h)))
                       : (l = Ve.makeLineSpan("frac-line", t)),
                    (h = l.height),
                    (c = l.height))
                  : ((l = null), (h = 0), (c = t.fontMetrics().defaultRuleThickness)),
               r.size === w.DISPLAY.size || "display" === e.size
                  ? ((m = t.fontMetrics().num1), (p = h > 0 ? 3 * c : 7 * c), (u = t.fontMetrics().denom1))
                  : (h > 0 ? ((m = t.fontMetrics().num2), (p = c)) : ((m = t.fontMetrics().num3), (p = 3 * c)),
                    (u = t.fontMetrics().denom2)),
               l)
            ) {
               const e = t.fontMetrics().axisHeight;
               m - i.depth - (e + 0.5 * h) < p && (m += p - (m - i.depth - (e + 0.5 * h))),
                  e - 0.5 * h - (a.height - u) < p && (u += p - (e - 0.5 * h - (a.height - u)));
               const r = -(e - 0.5 * h);
               d = Ve.makeVList(
                  {
                     positionType: "individualShift",
            ...
            return (
               ...
               (f =
                  null == e.leftDelim
                     ? lt(t, ["mopen"])
                     : yr.customSizedDelim(e.leftDelim, g, !0, t.havingStyle(r), e.mode, ["mopen"])),
               (b = e.continued
                  ? Ve.makeSpan([])
                  : null == e.rightDelim
                    ? lt(t, ["mclose"])
                    : yr.customSizedDelim(e.rightDelim, g, !0, t.havingStyle(r), e.mode, ["mclose"])),
               Ve.makeSpan(["mord"].concat(s.sizingClasses(t)), [f, Ve.makeSpan(["mfrac"], [d]), b], t)
            );
         },
         Wr = (e, t) => {
            let r = new gt.MathNode("mfrac", [vt(e.numer, t), vt(e.denom, t)]);
            if (e.hasBarLine) {
               if (e.barSize) {
      ...
      je({
         ...
         handler(e, t) {
            ...
            const n = t[4],
               o = t[5],
               s = Ze(t[0]),
               i = "atom" === s.type && "open" === s.family ? jr(s.text) : null,
               a = Ze(t[1]),
               l = "atom" === a.type && "close" === a.family ? jr(a.text) : null,
               h = qt(t[2], "size");
            let c,
               m = null;
      ...
      const $r = (e, t) => {
         ...
         let n, o;
         "supsub" === e.type
            ? ((n = e.sup ? ht(e.sup, t.havingStyle(r.sup()), t) : ht(e.sub, t.havingStyle(r.sub()), t)),
         ...
         if (
            ...
            const e = Ve.makeSpan(["mord", o.isOver ? "mover" : "munder"], [a], t);
            a = o.isOver
               ? Ve.makeVList(
                    {
                       positionType: "firstBaseline",
      ...
      je({
         ...
         mathmlBuilder: (e, t) => {
            const r = Ct(e.label);
            return new gt.MathNode(e.isOver ? "mover" : "munder", [vt(e.base, t), r]);
         },
      }),
         je({
            type: "href",
         ...
         je({
            ...
            handler: (e, t) => {
               ...
               return r.settings.isTrusted(l)
                  ? { type: "html", mode: r.mode, attributes: h, body: Ke(a) }
         ...
         je({
            ...
            handler: (e, t) => {
               let { parser: r } = e;
               return { type: "htmlmathml", mode: r.mode, html: Ke(t[0]), mathml: Ke(t[1]) };
            },
            htmlBuilder: (e, t) => {
      ...
      je({
         ...
         handler: (e, t, r) => {
            ...
            return (
               "" === l && ((l = h), (l = l.replace(/^.*[\\/]/, "")), (l = l.substring(0, l.lastIndexOf(".")))),
               o.settings.isTrusted({ command: "\\includegraphics", url: h })
                  ? { type: "includegraphics", mode: o.mode, alt: l, width: s, height: i, totalheight: a, src: h }
         ...
         mathmlBuilder: (e, t) => {
            ...
            let o = 0;
            if (
               (e.totalheight.number > 0 && ((o = P(e.totalheight, t) - n), r.setAttribute("valign", F(-o))),
               ...
               if (r.settings.strict) {
                  ...
                  e
                     ? (t ||
                       ...
                       "math" !== r.mode &&
                          r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + n + " works only in math mode"))
                     : t && r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + n + " doesn't support mu units");
               }
         ...
         je({
            ...
            htmlBuilder: (e, t) => {
               let r;
               "clap" === e.alignment
                  ? ((r = Ve.makeSpan([], [ht(e.body, t)])), (r = Ve.makeSpan(["inner"], [r], t)))
      ...
      const Jr = (e, t, r, n, o, s, i) => {
               ...
               m = Ve.makeVList(
                  {
                     ...
                     children: [
                        ...
                        { type: "elem", elem: h.elem, marginLeft: F(-s) },
         ...
         en = (e, t) => {
            let r,
               ...
               o,
               s = !1;
            "supsub" === e.type ? ((r = e.sup), (n = e.sub), (o = qt(e.base, "op")), (s = !0)) : (o = qt(e, "op"));
            const i = t.style;
            let a,
               h = !1;
            if ((i.size === w.DISPLAY.size && o.symbol && !l.contains(Qr, o.name) && (h = !0), o.symbol)) {
               const e = h ? "Size2-Regular" : "Size1-Regular";
               let r = "";
               if (
                  (("\\oiint" !== o.name && "\\oiiint" !== o.name) ||
                     ((r = o.name.slice(1)), (o.name = "oiint" === r ? "\\iint" : "\\iiint")),
                  (a = Ve.makeSymbol(o.name, e, "math", t, ["mop", "op-symbol", h ? "large-op" : "small-op"])),
                  r.length > 0)
               ) {
                  const e = a.italic,
               ...
               const e = [];
               for (let r = 1; r < o.name.length; r++) e.push(Ve.mathsym(o.name[r], o.mode, t));
               a = Ve.makeSpan(["mop"], e, t);
            }
            let c = 0,
               m = 0;
            return (
               (a instanceof Z || "\\oiint" === o.name || "\\oiiint" === o.name) &&
                  !o.suppressBaseShift &&
                  ((c = (a.height - a.depth) / 2 - t.fontMetrics().axisHeight), (m = a.italic)),
               s ? Jr(a, r, n, t, i, m, c) : (c && ((a.style.position = "relative"), (a.style.top = F(c))), a)
            );
         },
         tn = (e, t) => {
            let r;
            if (e.symbol)
               (r = new ut("mo", [ft(e.name, e.mode)])), l.contains(Qr, e.name) && r.setAttribute("largeop", "false");
      ...
      je({
         ...
         je({
            ...
            handler: (e, t) => {
               let { parser: r } = e;
               const n = t[0];
               return { type: "op", mode: r.mode, limits: !1, parentIsSupSub: !1, symbol: !1, body: Ke(n) };
            },
            htmlBuilder: en,
            mathmlBuilder: tn,
         });
      ...
      const on = (e, t) => {
         ...
         if (
            ("supsub" === e.type
               ? ((r = e.sup), (n = e.sub), (o = qt(e.base, "operatorname")), (i = !0))
               : (o = qt(e, "operatorname")),
            o.body.length > 0)
         ) {
      ...
      function sn(e, t, r) {
         ...
         for (let e = 0; e < n.length; e++) {
            ...
            s < 0
               ...
               : n[e].classes[s + 1] === "reset-size" + t.size && (n[e].classes[s + 1] = "reset-size" + r.size),
               (n[e].height *= o),
               (n[e].depth *= o);
         }
         return Ve.makeFragment(n);
      ...
      je({
               ...
               if (t instanceof gt.SpaceNode);
                  ...
                  switch (t.type) {
                     ...
                     case "mo": {
                        ...
                        1 === t.children.length && e instanceof gt.TextNode
         ...
         Br("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"),
         $e({
            type: "ordgroup",
            htmlBuilder(e, t) {
               return e.semisimple ? Ve.makeFragment(nt(e.body, t, !1)) : Ve.makeSpan(["mord"], nt(e.body, t, !0), t);
            },
            mathmlBuilder(e, t) {
         ...
         je({
            ...
            htmlBuilder: (e, t) => {
               ...
               return (
                  (r = Ve.makeVList({ positionType: "firstBaseline", children: [{ type: "elem", elem: r }] }, t)),
         ...
         je({
            ...
            htmlBuilder: (e, t) => {
               const r = Ve.makeSpan(["inner"], [ht(e.body, t.withPhantom())]),
                  n = Ve.makeSpan(["fix"], []);
         ...
         je({
            ...
            handler(e, t, r) {
               ...
               const o = r[0],
                  s = qt(t[0], "size"),
                  i = qt(t[1], "size");
               return { type: "rule", mode: n.mode, shift: o && qt(o, "size").value, width: s.value, height: i.value };
            },
            htmlBuilder(e, t) {
            ...
            mathmlBuilder(e, t) {
               ...
               return (
                  o >= 0
                     ...
                     : (a.setAttribute("height", F(o)), a.setAttribute("depth", F(-o))),
      ...
      je({
         ...
         handler: (e, t) => {
            ...
            return { type: "sizing", mode: o.mode, size: an.indexOf(n) + 1, body: s };
         },
         htmlBuilder: (e, t) => {
         ...
         je({
            ...
            htmlBuilder: (e, t) => {
               ...
               const n = Ve.makeVList({ positionType: "firstBaseline", children: [{ type: "elem", elem: r }] }, t);
               return Ve.makeSpan(["mord"], [n], t);
            },
            mathmlBuilder: (e, t) => {
               const r = new gt.MathNode("mpadded", [vt(e.body, t)]);
               return (
                  e.smashHeight && r.setAttribute("height", "0px"), e.smashDepth && r.setAttribute("depth", "0px"), r
               );
            },
         }),
         je({
            ...
            htmlBuilder(e, t) {
               ...
               const i = r.height + r.depth + s + n,
                  { span: a, ruleWidth: l, advanceWidth: h } = yr.sqrtImage(i, t),
                  c = a.height - l;
               ...
               if (e.index) {
                  const r = t.havingStyle(w.SCRIPTSCRIPT),
                     ...
                     s = Ve.makeVList(
                        { positionType: "shift", positionData: -o, children: [{ type: "elem", elem: n }] },
                        t
                     ),
            ...
            mathmlBuilder(e, t) {
               ...
               return n ? new gt.MathNode("mroot", [vt(r, t), vt(n, t)]) : new gt.MathNode("msqrt", [vt(r, t)]);
            },
         });
      const ln = { display: w.DISPLAY, text: w.TEXT, script: w.SCRIPT, scriptscript: w.SCRIPTSCRIPT };
      je({
         type: "styling",
      ...
      $e({
         ...
         htmlBuilder(e, t) {
               ...
               if (r)
                  return "op" === r.type
                     ? r.limits && (t.style.size === w.DISPLAY.size || r.alwaysHandleSupSub)
                        ...
                        : null
                     : "operatorname" === r.type
                       ? r.alwaysHandleSupSub && (t.style.size === w.DISPLAY.size || r.limits)
                          ? on
                          : null
                       : "accent" === r.type
            ...
            if (o) {
               ...
               (a = ht(o, e, t)), u || (m = i.height - (e.fontMetrics().supDrop * e.sizeMultiplier) / t.sizeMultiplier);
            }
            if (s) {
               const e = t.havingStyle(t.style.sub());
               (h = ht(s, e, t)), u || (p = i.depth + (e.fontMetrics().subDrop * e.sizeMultiplier) / t.sizeMultiplier);
            }
            let d;
            ...
            if (a && h) {
               (m = Math.max(m, d, a.depth + 0.25 * c.xHeight)), (p = Math.max(p, c.sub2));
               ...
               b = Ve.makeVList({ positionType: "individualShift", children: r }, t);
            } else if (h) {
               p = Math.max(p, c.sub1, h.height - 0.8 * c.xHeight);
               const e = [{ type: "elem", elem: h, marginLeft: y, marginRight: f }];
               b = Ve.makeVList({ positionType: "shift", positionData: p, children: e }, t);
            } else {
               if (!a) throw new Error("supsub must have either sup or sub.");
               (m = Math.max(m, d, a.depth + 0.25 * c.xHeight)),
                  (b = Ve.makeVList(
                     { positionType: "shift", positionData: -m, children: [{ type: "elem", elem: a, marginRight: f }] },
                     t
                  ));
            }
         ...
         mathmlBuilder(e, t) {
            ...
            const s = [vt(e.base, t)];
            let i;
            if ((e.sub && s.push(vt(e.sub, t)), e.sup && s.push(vt(e.sup, t)), o)) i = r ? "mover" : "munder";
            else if (e.sub)
               if (e.sup) {
                  const r = e.base;
                  i =
                     (r && "op" === r.type && r.limits && t.style === w.DISPLAY) ||
                     (r && "operatorname" === r.type && r.alwaysHandleSupSub && (t.style === w.DISPLAY || r.limits))
                        ? "munderover"
                        : "msubsup";
               } else {
                  const r = e.base;
                  i =
                     (r && "op" === r.type && r.limits && (t.style === w.DISPLAY || r.alwaysHandleSupSub)) ||
                     (r && "operatorname" === r.type && r.alwaysHandleSupSub && (r.limits || t.style === w.DISPLAY))
                        ? "munder"
                        : "msub";
               }
            else {
      ...
      $e({
         ...
         mathmlBuilder(e, t) {
            ...
            return (r = new gt.MathNode("mtext", [new gt.TextNode("\xa0")])), r;
         },
      });
      const pn = () => {
      ...
      je({
         ...
         je({
            ...
            htmlBuilder(e, t) {
               ...
               return Ve.makeVList(
                  { positionType: "shift", positionData: o, children: [{ type: "elem", elem: r }] },
                  t
               );
            },
            mathmlBuilder(e, t) {
               return new gt.MathNode("mpadded", [vt(e.body, t)], ["vcenter"]);
            },
         }),
         je({
            type: "verb",
            ...
            htmlBuilder(e, t) {
               ...
               for (let t = 0; t < r.length; t++) {
                  let s = r[t];
                  "~" === s && (s = "\\textasciitilde"),
                     n.push(Ve.makeSymbol(s, "Typewriter-Regular", e.mode, o, ["mord", "texttt"]));
               }
               return Ve.makeSpan(["mord", "text"].concat(o.sizingClasses(t)), Ve.tryCombineChars(n), o);
            },
            mathmlBuilder(e, t) {
      ...
      class Mn {
         ...
         lex() {
            ...
            if (null === r || r.index !== t)
               throw new n("Unexpected character: '" + e[t] + "'", new Nr(e[t], new Cr(this, t, t + 1)));
            const o = r[6] || r[3] || (r[2] ? "\\ " : " ");
      ...
      Br("\\char", function (e) {
         ...
         if (t) {
            if (((o = Tn[r.text]), null == o || o >= t)) throw new n("Invalid base-" + t + " digit " + r.text);
            let s;
            for (; null != (s = Tn[e.future().text]) && s < t; ) (o *= t), (o += s), e.popToken();
         }
         return "\\@char{" + o + "}";
      });
      const Bn = (e, t, r) => {
      ...
      Br("\\newcommand", (e) => Bn(e, !1, !0)),
         ...
         Br("\\show", (e) => {
            const t = e.popToken(),
               r = t.text;
            return console.log(t, e.macros.get(r), yn[r], oe.math[r], oe.text[r]), "";
         }),
         Br("\\bgroup", "{"),
         Br("\\egroup", "}"),
         Br("~", "\\nobreakspace"),
         ...
         Br("\\aa", "\\r a"),
         Br("\\AA", "\\r A"),
         Br("\\textcopyright", "\\html@mathml{\\textcircled{c}}{\\char`\xa9}"),
         Br("\\copyright", "\\TextOrMath{\\textcopyright}{\\text{\\textcopyright}}"),
         Br("\\textregistered", "\\html@mathml{\\textcircled{\\scriptsize R}}{\\char`\xae}"),
         Br("\u212c", "\\mathscr{B}"),
         Br("\u2130", "\\mathscr{E}"),
         Br("\u2131", "\\mathscr{F}"),
         Br("\u210b", "\\mathscr{H}"),
         ...
         Br("\u2259", "\\html@mathml{\\stackrel{\\tiny\\wedge}{=}}{\\mathrel{\\char`\u2258}}"),
         Br("\u225a", "\\html@mathml{\\stackrel{\\tiny\\vee}{=}}{\\mathrel{\\char`\u225a}}"),
         Br("\u225b", "\\html@mathml{\\stackrel{\\scriptsize\\star}{=}}{\\mathrel{\\char`\u225b}}"),
         Br("\u225d", "\\html@mathml{\\stackrel{\\tiny\\mathrm{def}}{=}}{\\mathrel{\\char`\u225d}}"),
         Br("\u225e", "\\html@mathml{\\stackrel{\\tiny\\mathrm{m}}{=}}{\\mathrel{\\char`\u225e}}"),
         Br("\u225f", "\\html@mathml{\\stackrel{\\tiny?}{=}}{\\mathrel{\\char`\u225f}}"),
         Br("\u27c2", "\\perp"),
         ...
         Br("\ufe0f", "\\textregistered"),
         Br("\\ulcorner", '\\html@mathml{\\@ulcorner}{\\mathop{\\char"231c}}'),
         Br("\\urcorner", '\\html@mathml{\\@urcorner}{\\mathop{\\char"231d}}'),
         Br("\\llcorner", '\\html@mathml{\\@llcorner}{\\mathop{\\char"231e}}'),
         Br("\\lrcorner", '\\html@mathml{\\@lrcorner}{\\mathop{\\char"231f}}'),
      ...
      Br("\\dotso", function (e) {
         ...
         Br("\\pod", "\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern8mu}{\\mkern8mu}{\\mkern8mu}(#1)"),
         Br("\\pmod", "\\pod{{\\rm mod}\\mkern6mu#1}"),
         Br("\\mod", "\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern12mu}{\\mkern12mu}{\\mkern12mu}{\\rm mod}\\,\\,#1"),
         Br("\\newline", "\\\\\\relax"),
         Br("\\TeX", "\\textrm{\\html@mathml{T\\kern-.1667em\\raisebox{-.5ex}{E}\\kern-.125emX}{TeX}}");
      const qn = F(T["Main-Regular"]["T".charCodeAt(0)][1] - 0.7 * T["Main-Regular"]["A".charCodeAt(0)][1]);
      Br(
         "\\LaTeX",
         "\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{" + qn + "}{\\scriptstyle A}\\kern-.15em\\TeX}{LaTeX}}"
      ),
         Br(
            "\\KaTeX",
            "\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{" + qn + "}{\\scriptstyle A}\\kern-.15em\\TeX}{KaTeX}}"
         ),
         ...
         Br("\\coloneqq", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}=}}{\\mathop{\\char"2254}}'),
         Br(
            "\\Coloneqq",
         ...
         Br("\\eqqcolon", '\\html@mathml{\\mathrel{=\\mathrel{\\mkern-1.2mu}\\vcentcolon}}{\\mathop{\\char"2255}}'),
         Br(
            "\\Eqqcolon",
         ...
         Br("\\simcolon", "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}"),
         Br("\\simcoloncolon", "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\dblcolon}"),
         Br("\\approxcolon", "\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\vcentcolon}"),
         Br("\\approxcoloncolon", "\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\dblcolon}"),
         Br("\\notni", "\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}"),
         ...
         Br("\\llbracket", "\\html@mathml{\\mathopen{[\\mkern-3.2mu[}}{\\mathopen{\\char`\u27e6}}"),
         Br("\\rrbracket", "\\html@mathml{\\mathclose{]\\mkern-3.2mu]}}{\\mathclose{\\char`\u27e7}}"),
         Br("\u27e6", "\\llbracket"),
         Br("\u27e7", "\\rrbracket"),
         Br("\\lBrace", "\\html@mathml{\\mathopen{\\{\\mkern-3.2mu[}}{\\mathopen{\\char`\u2983}}"),
         Br("\\rBrace", "\\html@mathml{\\mathclose{]\\mkern-3.2mu\\}}}{\\mathclose{\\char`\u2984}}"),
         Br("\u2983", "\\lBrace"),
         Br("\u2984", "\\rBrace"),
         Br(
            "\\minuso",
      ...
      Br("\\bra@ket", In(!1)),
         Br("\\bra@set", In(!0)),
         Br("\\Braket", "\\bra@ket{\\left\\langle}{\\,\\middle\\vert\\,}{\\,\\middle\\vert\\,}{\\right\\rangle}"),
      ...
      class Hn {
         ...
         scanArgument(e) {
            ...
            return this.pushToken(new Nr("EOF", r.loc)), this.pushTokens(n), t.range(r, "");
         }
         consumeSpaces() {
            for (;;) {
         ...
         consumeArg(e) {
            ...
            do {
               if (((s = this.popToken()), t.push(s), "{" === s.text)) ++i;
                  ...
                  throw new n(
                     "Unexpected end of input in a macro argument, expected '" + (e && r ? e[a] : "}") + "'",
                     s
                  );
               if (e && r)
               ...
               if ("\\limits" === e.text || "\\nolimits" === e.text) {
                  ...
                  if (!En[e.text]) break;
                  {
                     const t = On.test(e.text),
                        n = [];
                     for (n.push(new Nr(En[e.text])), this.consume(); ; ) {
         ...
         formLigatures(e) {
            ...
            for (let r = 0; r < t; ++r) {
               ...
               "-" === o &&
                  "-" === e[r + 1].text &&
                  (r + 1 < t && "-" === e[r + 2].text
                     ? (e.splice(r, 3, { type: "textord", mode: "text", loc: Cr.range(n, e[r + 2]), text: "---" }),
                       (t -= 2))
                     : (e.splice(r, 2, { type: "textord", mode: "text", loc: Cr.range(n, e[r + 1]), text: "--" }),
                       (t -= 1))),
                  ("'" !== o && "`" !== o) ||
                     e[r + 1].text !== o ||
                     (e.splice(r, 2, { type: "textord", mode: "text", loc: Cr.range(n, e[r + 1]), text: o + o }),
                     (t -= 1));
            }
         }
         parseSymbol() {
            ...
            let o;
            if (
               (r && ((t = t.substring(0, r.index)), "i" === t ? (t = "\u0131") : "j" === t && (t = "\u0237")),
               oe[this.mode][t])
            ) {
               this.settings.strict &&
                  "math" === this.mode &&
               ...
               this.settings.strict &&
                  ...
                  (o = { type: "textord", mode: "text", loc: Cr.range(e), text: t });
            }
            if ((this.consume(), r))
               for (let t = 0; t < r[0].length; t++) {
                  const s = r[0][t];
                  if (!Ln[s]) throw new n("Unknown accent ' " + s + "'", e);
      ...
      var Pn = function (e, t) {
         ...
         if (
            ...
            o = [{ type: "tag", mode: "text", body: o, tag: r.subparse([new Nr("\\df@tag")]) }];
         }
         return o;
      };
