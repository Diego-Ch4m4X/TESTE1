// emojis.v3.js (fallback offline map; online update is handled in app.js)
window.dicionarioEmojis = window.dicionarioEmojis || {
  // minimal fallback (GitHub-style shortcodes)
  "bowtie": "🎀",
     "+1": "👍",
     "-1": "👎",
     "8ball": "🎱",
     ...
     zombie: "🧟‍♂️",
     zzz: "💤",
  // GitHub custom emojis (offline unicode approximations)
  shipit: "🐙",
  feelsgood: "😌",
  finnadie: "😵",
  goberserk: "🤪",
